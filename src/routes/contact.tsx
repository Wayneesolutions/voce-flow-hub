  ...
  head: () => ({
    meta: [
      { title: "Book a VoCallM demo" },
      {
        name: "description",
        content:
          "Talk to the Wayne Solutions team. Book a 20-minute demo and see VoCallM call a real lead live.",
      },
    ],
  }),
  component: Contact,
      ...
      <section className="container-page py-20 grid lg:grid-cols-2 gap-12">
        <div>
          ...
          <p className="mt-5 text-lg text-muted-foreground max-w-lg">
            Fill out the form and a member of the Wayne Solutions team will get back within one
