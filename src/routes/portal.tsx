...
const items: NavEntry[] = [
  ...
  { to: "/portal/callbacks", label: "Callback List", icon: <PhoneForwarded className="h-4 w-4" /> },
  ...
  { to: "/portal/whatsapp/templates",  label: "Templates", icon: <FileText className="h-4 w-4" /> },
